...
from taiga.projects.issues.api import dashboard_graph_data, dashboard, new_registerd_user
...
urlpatterns = [
    ...
    url('^new_registerd_user/', new_registerd_user, name='new-registered-user'),
]
