...
class Project(ProjectDefaults, TaggedMixin, TagsColorsMixin, models.Model):
    ...
    authority = models.CharField(max_length=150, verbose_name='Autority', null=True, blank=True)
    concessionaire = models.CharField(max_length=150, verbose_name='Concessionaire', null=True, blank=True)
    package_no = models.CharField(max_length=200, verbose_name='Package No', null=True, blank=True)
    start_and_end_chainage = models.CharField(max_length=400, verbose_name='Start and End Chainage', null=True, blank=True)
    independent_consultant_during_O_and_M_period = models.CharField(max_length=500, verbose_name='Independent Consultant during O & M period', null=True, blank=True)
    epc_contractor = models.CharField(max_length=200, verbose_name='EPC Contractor', null=True, blank=True)
    date_of_signing_of_concession_agreement = models.CharField(max_length=200, verbose_name='Date of signing of Concession Agreement', null=True, blank=True)
    appointed_date = models.CharField(max_length=200, verbose_name='Appointed Date O & M Handover Date', null=True, blank=True)
    O_M_handover_date = models.CharField(max_length=200, verbose_name='O & M handover date', null=True, blank=True)
    scheduled_end_of_concession = models.CharField(max_length=200, verbose_name='Scheduled End of Concession', null=True, blank=True)    
